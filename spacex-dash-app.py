...
sites = spacex_df["Launch Site"].drop_duplicates().tolist()
dropdown_sites = [{'label': 'All Sites', 'value': 'ALL'}]
for site in sites:
    dropdown_sites.append({'label': site, 'value': site})
...
def get_scatter_plot(entered_site, payload_range):
    #entered_site = entered_values[0]
    #payload_range= entered_values[1]
    if entered_site == 'ALL':
